...
public class BehaviorAdapterFactory extends AdapterFactoryImpl {
	...
	protected BehaviorSwitch<Adapter> modelSwitch =
		new BehaviorSwitch<Adapter>() {
			...
			@Override
			public Adapter caseOptionalMessage(OptionalMessage object) {
				return createOptionalMessageAdapter();
			}
			@Override
			public Adapter caseAlternativeMessage(AlternativeMessage object) {
				return createAlternativeMessageAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link behavior.OptionalMessage <em>Optional Message</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createOptionalMessageAdapter() {
		return null;
	}
