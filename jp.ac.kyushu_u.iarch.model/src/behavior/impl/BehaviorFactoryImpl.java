...
public class BehaviorFactoryImpl extends EFactoryImpl implements BehaviorFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case BehaviorPackage.OPTIONAL_MESSAGE: return createOptionalMessage();
			case BehaviorPackage.ALTERNATIVE_MESSAGE: return createAlternativeMessage();
			default:
	 ...
	 * @generated
	 */
	public OptionalMessage createOptionalMessage() {
		OptionalMessageImpl optionalMessage = new OptionalMessageImpl();
	 ...
	 * @generated
	 */
	public AlternativeMessage createAlternativeMessage() {
		AlternativeMessageImpl alternativeMessage = new AlternativeMessageImpl();
