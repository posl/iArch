...
public class UmlClassPackageImpl extends EPackageImpl implements UmlClassPackage {
	 ...
	 * @generated
	 */
	private EClass optionalOperationEClass = null;
	 ...
	 * @generated
	 */
	public EClass getOptionalOperation() {
		return optionalOperationEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getAlternativeOperation_Operations() {
	...
	public void createPackageContents() {
		...
		optionalOperationEClass = createEClass(OPTIONAL_OPERATION);

		alternativeOperationEClass = createEClass(ALTERNATIVE_OPERATION);
		createEReference(alternativeOperationEClass, ALTERNATIVE_OPERATION__OPERATIONS);
	...
	public void initializePackageContents() {
		...
		optionalOperationEClass.getESuperTypes().add(this.getOperation());
		alternativeOperationEClass.getESuperTypes().add(this.getOperation());
		...
		initEClass(optionalOperationEClass, OptionalOperation.class, "OptionalOperation", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		...
		initEReference(getAlternativeOperation_Operations(), this.getOperation(), null, "operations", null, 0, -1, AlternativeOperation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
