...
import jp.ac.kyushu.iarch.checkplugin.testsupport.AspectGenerator;

public class GenerateAspectCode implements IHandler {
	...
	public Object execute(ExecutionEvent arg0) throws ExecutionException {
		try {
			new AspectGenerator().generateAspectCode();
		} catch (Exception e) {
