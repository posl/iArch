...
public class UmlClassSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case UmlClassPackage.OPTIONAL_OPERATION: {
				OptionalOperation optionalOperation = (OptionalOperation)theEObject;
				T result = caseOptionalOperation(optionalOperation);
				if (result == null) result = caseOperation(optionalOperation);
				if (result == null) result = caseNamedElement(optionalOperation);
				if (result == null) result = caseElement(optionalOperation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UmlClassPackage.ALTERNATIVE_OPERATION: {
				...
				if (result == null) result = caseOperation(alternativeOperation);
				if (result == null) result = caseNamedElement(alternativeOperation);
				if (result == null) result = caseElement(alternativeOperation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Optional Operation</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Optional Operation</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseOptionalOperation(OptionalOperation object) {
		return null;
	}
