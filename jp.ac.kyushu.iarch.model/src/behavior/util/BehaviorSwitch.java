...
public class BehaviorSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case BehaviorPackage.OPTIONAL_MESSAGE: {
				OptionalMessage optionalMessage = (OptionalMessage)theEObject;
				T result = caseOptionalMessage(optionalMessage);
				if (result == null) result = caseMessage(optionalMessage);
				if (result == null) result = caseNamedElement(optionalMessage);
				if (result == null) result = caseElement(optionalMessage);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BehaviorPackage.ALTERNATIVE_MESSAGE: {
				AlternativeMessage alternativeMessage = (AlternativeMessage)theEObject;
				T result = caseAlternativeMessage(alternativeMessage);
				if (result == null) result = caseMessage(alternativeMessage);
				if (result == null) result = caseNamedElement(alternativeMessage);
				if (result == null) result = caseElement(alternativeMessage);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Optional Message</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Optional Message</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseOptionalMessage(OptionalMessage object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Alternative Message</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Alternative Message</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAlternativeMessage(AlternativeMessage object) {
		return null;
	}
