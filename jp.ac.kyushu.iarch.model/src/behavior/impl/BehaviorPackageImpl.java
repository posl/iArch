...
public class BehaviorPackageImpl extends EPackageImpl implements BehaviorPackage {
	 ...
	 * @generated
	 */
	private EClass optionalMessageEClass = null;
	 ...
	 * @generated
	 */
	private EClass alternativeMessageEClass = null;
	 ...
	 * @generated
	 */
	public EClass getOptionalMessage() {
		return optionalMessageEClass;
	}
	 ...
	 * @generated
	 */
	public EClass getAlternativeMessage() {
		return alternativeMessageEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getAlternativeMessage_Messages() {
		return (EReference)alternativeMessageEClass.getEStructuralFeatures().get(0);
	}
	...
	public void createPackageContents() {
		...
		optionalMessageEClass = createEClass(OPTIONAL_MESSAGE);

		alternativeMessageEClass = createEClass(ALTERNATIVE_MESSAGE);
		createEReference(alternativeMessageEClass, ALTERNATIVE_MESSAGE__MESSAGES);
	}
	...
	public void initializePackageContents() {
		...
		optionalMessageEClass.getESuperTypes().add(this.getMessage());
		alternativeMessageEClass.getESuperTypes().add(this.getMessage());
		...
		initEClass(optionalMessageEClass, OptionalMessage.class, "OptionalMessage", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(alternativeMessageEClass, AlternativeMessage.class, "AlternativeMessage", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getAlternativeMessage_Messages(), this.getMessage(), null, "messages", null, 0, -1, AlternativeMessage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
