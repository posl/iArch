...
public interface BehaviorPackage extends EPackage {
	...
	/**
	 * The meta object id for the '{@link behavior.impl.OptionalMessageImpl <em>Optional Message</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see behavior.impl.OptionalMessageImpl
	 * @see behavior.impl.BehaviorPackageImpl#getOptionalMessage()
	 * @generated
	 */
	int OPTIONAL_MESSAGE = 30;
	 ...
	 * @ordered
	 */
	int OPTIONAL_MESSAGE__OWNED_COMMENT = MESSAGE__OWNED_COMMENT;
	 ...
	 * @ordered
	 */
	int OPTIONAL_MESSAGE__OWNER = MESSAGE__OWNER;
	 ...
	 * @ordered
	 */
	int OPTIONAL_MESSAGE__OWNED_ELEMENT = MESSAGE__OWNED_ELEMENT;
	 ...
	 * @ordered
	 */
	int OPTIONAL_MESSAGE__NAME = MESSAGE__NAME;
	 ...
	 * @ordered
	 */
	int OPTIONAL_MESSAGE__ARCHPOINT = MESSAGE__ARCHPOINT;
	 ...
	 * @ordered
	 */
	int OPTIONAL_MESSAGE__INTERACTION = MESSAGE__INTERACTION;
	 ...
	 * @ordered
	 */
	int OPTIONAL_MESSAGE__RECEIVE_EVENT = MESSAGE__RECEIVE_EVENT;
	 ...
	 * @ordered
	 */
	int OPTIONAL_MESSAGE__SEND_EVENT = MESSAGE__SEND_EVENT;
	 ...
	 * @ordered
	 */
	int OPTIONAL_MESSAGE__CONNECTOR = MESSAGE__CONNECTOR;
	 ...
	 * @ordered
	 */
	int OPTIONAL_MESSAGE__MESSAGE_ORDER = MESSAGE__MESSAGE_ORDER;

	/**
	 * The number of structural features of the '<em>Optional Message</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int OPTIONAL_MESSAGE_FEATURE_COUNT = MESSAGE_FEATURE_COUNT + 0;

	/**
	 * The number of operations of the '<em>Optional Message</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int OPTIONAL_MESSAGE_OPERATION_COUNT = MESSAGE_OPERATION_COUNT + 0;

	/**
	 * The meta object id for the '{@link behavior.impl.AlternativeMessageImpl <em>Alternative Message</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see behavior.impl.AlternativeMessageImpl
	 * @see behavior.impl.BehaviorPackageImpl#getAlternativeMessage()
	 * @generated
	 */
	int ALTERNATIVE_MESSAGE = 31;
	 ...
	 * @ordered
	 */
	int ALTERNATIVE_MESSAGE__OWNED_COMMENT = MESSAGE__OWNED_COMMENT;
	 ...
	 * @ordered
	 */
	int ALTERNATIVE_MESSAGE__OWNER = MESSAGE__OWNER;
	 ...
	 * @ordered
	 */
	int ALTERNATIVE_MESSAGE__OWNED_ELEMENT = MESSAGE__OWNED_ELEMENT;
	 ...
	 * @ordered
	 */
	int ALTERNATIVE_MESSAGE__NAME = MESSAGE__NAME;
	 ...
	 * @ordered
	 */
	int ALTERNATIVE_MESSAGE__ARCHPOINT = MESSAGE__ARCHPOINT;
	 ...
	 * @ordered
	 */
	int ALTERNATIVE_MESSAGE__INTERACTION = MESSAGE__INTERACTION;
	 ...
	 * @ordered
	 */
	int ALTERNATIVE_MESSAGE__RECEIVE_EVENT = MESSAGE__RECEIVE_EVENT;
	 ...
	 * @ordered
	 */
	int ALTERNATIVE_MESSAGE__SEND_EVENT = MESSAGE__SEND_EVENT;
	 ...
	 * @ordered
	 */
	int ALTERNATIVE_MESSAGE__CONNECTOR = MESSAGE__CONNECTOR;
	 ...
	 * @ordered
	 */
	int ALTERNATIVE_MESSAGE__MESSAGE_ORDER = MESSAGE__MESSAGE_ORDER;
	 ...
	 * @ordered
	 */
	int ALTERNATIVE_MESSAGE__MESSAGES = MESSAGE_FEATURE_COUNT + 0;

	/**
	 * The number of structural features of the '<em>Alternative Message</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int ALTERNATIVE_MESSAGE_FEATURE_COUNT = MESSAGE_FEATURE_COUNT + 1;

	/**
	 * The number of operations of the '<em>Alternative Message</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int ALTERNATIVE_MESSAGE_OPERATION_COUNT = MESSAGE_OPERATION_COUNT + 0;
	...
	/**
	 * Returns the meta object for class '{@link behavior.OptionalMessage <em>Optional Message</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Optional Message</em>'.
	 * @see behavior.OptionalMessage
	 * @generated
	 */
	EClass getOptionalMessage();

	/**
	 * Returns the meta object for class '{@link behavior.AlternativeMessage <em>Alternative Message</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Alternative Message</em>'.
	 * @see behavior.AlternativeMessage
	 * @generated
	 */
	EClass getAlternativeMessage();

	/**
	 * Returns the meta object for the reference list '{@link behavior.AlternativeMessage#getMessages <em>Messages</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference list '<em>Messages</em>'.
	 * @see behavior.AlternativeMessage#getMessages()
	 * @see #getAlternativeMessage()
	 * @generated
	 */
	EReference getAlternativeMessage_Messages();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '{@link behavior.impl.OptionalMessageImpl <em>Optional Message</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see behavior.impl.OptionalMessageImpl
		 * @see behavior.impl.BehaviorPackageImpl#getOptionalMessage()
		 * @generated
		 */
		EClass OPTIONAL_MESSAGE = eINSTANCE.getOptionalMessage();

		/**
		 * The meta object literal for the '{@link behavior.impl.AlternativeMessageImpl <em>Alternative Message</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see behavior.impl.AlternativeMessageImpl
		 * @see behavior.impl.BehaviorPackageImpl#getAlternativeMessage()
		 * @generated
		 */
		EClass ALTERNATIVE_MESSAGE = eINSTANCE.getAlternativeMessage();
		 ...
		 * @generated
		 */
		EReference ALTERNATIVE_MESSAGE__MESSAGES = eINSTANCE.getAlternativeMessage_Messages();
