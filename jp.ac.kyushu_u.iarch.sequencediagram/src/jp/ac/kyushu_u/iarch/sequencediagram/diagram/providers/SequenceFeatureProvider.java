package jp.ac.kyushu_u.iarch.sequencediagram.diagram.providers;
...
import jp.ac.kyushu_u.iarch.sequencediagram.features.*;
...
public class SequenceFeatureProvider extends DefaultFeatureProvider {
	...
	public IAddFeature getAddFeature(IAddContext context) {
		...
		} else if (newObject instanceof behavior.Object) {
			return new AddObjectFeature(this);
		} else if (newObject instanceof Lifeline) {
			return new AddLifelineFeature(this);
		} else if (newObject instanceof OptionalMessage) {
			return new AddOptionalMessageFeature(this);
		} else if (newObject instanceof AlternativeMessage) {
			return new AddAlternativeMessageFeature(this);
		} else if (newObject instanceof Message) {
	...
	public ICreateConnectionFeature[] getCreateConnectionFeatures() {
		return new ICreateConnectionFeature[] {
				new CreateLifelineFeature(this),
				new CreateMessageFeature(this),
				new CreateOptionalMessageFeature(this),
				new CreateAlternativeMessageFeature(this) };
	}
